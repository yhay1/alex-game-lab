...
export type Database = {
  public: {
    Tables: {
      ...
      game_assets: {
        Row: { id: string; project_id: string | null; owner_id: string; name: string; description: string | null; asset_type: 'image' | 'sprite' | 'audio'; kind: string; storage_path: string; mime_type: string; size_bytes: number; width: number | null; height: number | null; duration_seconds: number | null; visibility: 'public' | 'private'; source_type: 'upload' | 'generated' | 'imported'; source_url: string | null; license: string | null; tags: string[]; classification_status: 'unclassified' | 'pending' | 'classified'; metadata: Json; created_at: string; updated_at: string }
        Insert: { id?: string; project_id: string | null; owner_id: string; name: string; description?: string | null; asset_type: 'image' | 'sprite' | 'audio'; kind?: string; storage_path: string; mime_type: string; size_bytes: number; width?: number | null; height?: number | null; duration_seconds?: number | null; visibility?: 'public' | 'private'; source_type?: 'upload' | 'generated' | 'imported'; source_url?: string | null; license?: string | null; tags?: string[]; classification_status?: 'unclassified' | 'pending' | 'classified'; metadata?: Json; created_at?: string; updated_at?: string }
