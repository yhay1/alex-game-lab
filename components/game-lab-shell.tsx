...
import { Gamepad2, LayoutDashboard, FolderKanban, Plus, Settings, Menu, X } from 'lucide-react'
...
const links = [
  ...
  { href: '/dashboard/create', label: 'Create Game', icon: Plus },
]
